...
| `inflight_check_retries`             | 5&nbsp;queries | Maximum liveness probes for an in‑flight order; exhaustion does not infer a terminal state.                                                                                                    |
...
| `open_check_missing_retries`         | 5&nbsp;retries | Authoritative bulk misses required before a complete targeted not‑found query may resolve an eligible order.                                                                                   |
