...
use nautilus_model::{
    ...
    events::{
        ...
        OrderEmulated, OrderExpired, OrderFillConfirmed, OrderFillVoided, OrderFilled,
        OrderInitialized, OrderModifyRejected, OrderPendingCancel, OrderPendingUpdate,
        OrderRejected, OrderReleased, OrderSnapshot, OrderSubmitted, OrderTriggered, OrderUpdated,
...
impl_catalog_path_prefix!(OrderFillConfirmed, "order_fill_confirmed");
